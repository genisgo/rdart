...
// /// Contrôleur pour piloter le PdfReader (page/zoom).
// class PdfController {
//   void Function(int page)? _setPage;
//   void Function(double zoom)? _setZoom;
//   void Function()? _zoomIn;
...
// /// Un lecteur PDF basé sur l’iframe natif du navigateur.
// /// Supporte les paramètres hash: #page=X&zoom=Y (Chrome/Edge/Firefox).
// class PdfReader extends Relement {
//   final String src; // URL/chemin du PDF
//   final PdfController? controller; // optionnel
//   final int initialPage; // 1..n
//   final double initialZoom; // ex: 100 = 100%
//   final double? width; // px
//   final double? height; // px
//   final bool showToolbar; // affiche un mini toolbar
...
//       // Conserve des refs pour MAJ texte
//       _pageInfoEl = pageInfo;
//       _zoomInfoEl = zoomInfo;
//       _root.append(_toolbar);
//     }
...
//           ..style.border = '0'
//           ..style.width =
//               (width != null ? '${width!.toStringAsFixed(0)}px' : '100%')
//           ..style.height =
//               (height != null ? '${height!.toStringAsFixed(0)}px' : '600px')
//           ..src = _composeUrl();
...
//   void _goNext() {
//     _page +=
//         1; // on ne connaît pas la dernière page sans PDF.js ; on laisse avancer
//     _reload();
//   }

//   void _zoomIn() {
//     _zoom = (_zoom + 10).clamp(5, 800);
//     _reload();
//   }
...
//   // --- URL builder: utilise hash #page=&zoom= (supporté par la majorité des viewers intégrés)
//   String _composeUrl() {
//     // Beaucoup de navigateurs comprennent:
//     //  #page=2&zoom=150
//     final hash = '#page=$_page&zoom=${_zoom.toStringAsFixed(0)}';
//     // Si ton src contient déjà un hash/query, on concatène proprement
//     if (src.contains('#')) {
...
//     }
//     return '$src$hash';
//     // NOTE: si tu souhaites un contrôle total cross-browser,
//     // intègre PDF.js (viewer.html?file=...) et garde ce composant comme façade.
//   }
