...
class Btext extends Bootstrap {
  ...
  static const truncate = Btext._("text-truncate");
...
base class _Fs extends Bootstrap {
  const _Fs(super.cname);
  _Fs get f1 => _Fs("fs-1");
  _Fs get f2 => _Fs("fs-2");
  _Fs get f3 => _Fs("fs-3");
  _Fs get f4 => _Fs("fs-4");
...
///Font Weight
base class _Fw extends Bootstrap {
  const _Fw(super.cname);

  _Fw get bold => _Fw("font-weight-bold");

  _Fw get normal => _Fw("font-weight-normal");

  _Fw get light => _Fw("font-weight-light");

  _Fw get italic => _Fw("font-weight-italic");
}
